    ...
    <div class="panel-body">
        <form class="form-horizontal" role="form" id="referenceForm" action=${param.bookletpath} method="POST" >
            ...
            <div class="form-group">
                ...
                <div class ="col-xs-11">
                    <input class="form-control" type="text" name="howpublished" id="booklet-howpublished">
                </div>
            </div> 
            ...
            <button type="submit" id ="booklet-add" class="btn btn-default">Add reference</button>
        </form>
    </div>
</div>