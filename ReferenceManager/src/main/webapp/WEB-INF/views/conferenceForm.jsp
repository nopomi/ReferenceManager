<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">Conference Reference</h4>
    </div>
    <div class="panel-body">
        <form class="form-horizontal" role="form" id="referenceForm" action=${param.conferencepath} method="POST" >
            ...
            <button type="submit" id ="conference-add" class="btn btn-default">Add reference</button>
        </form>
    </div>
</div>